...
using OrderCancellationConverter = Duffel.ApiClient.Interfaces.Converters.OrderCancellationConverter;
using OrderConverter = Duffel.ApiClient.Interfaces.Converters.OrderConverter;
using PagedResponseConverter = Duffel.ApiClient.Interfaces.Converters.PagedResponseConverter;
